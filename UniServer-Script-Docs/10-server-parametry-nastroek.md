...
Возвращает значение параметра настройки сервера по имени. Базовое чтение конфигурации (например `Core.ServerID` или ключи вида `PluginName + '.…'`).
...
Возвращает параметр конфигурации как `Double`, либо `ADefValue`, если значения нет или оно не число.
...
Возвращает параметр конфигурации как `Integer`, либо `ADefValue`, если значения нет или оно не целое.
...
Возвращает параметр конфигурации как `Boolean`, либо `ADefValue`, если значения нет или оно не логическое.
