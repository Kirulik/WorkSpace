...
| Файл | Содержание |
|------|------------|
| [01-Script-API-Reference.md](01-Script-API-Reference.md) | **Основной мануал:** подробный справочник всех функций и объектов из `functions.txt` |
| [02-Quick-Cookbook.md](02-Quick-Cookbook.md) | Краткие рецепты типовых задач (HTTP-страница, сообщения, журналы, JSON) |
| [sources/EventScript_desc-extract.md](sources/EventScript_desc-extract.md) | Очищенная выдержка из EventScript_desc.odt |
| [sources/PluginAPI_desc-extract.md](sources/PluginAPI_desc-extract.md) | Очищенная выдержка из PluginAPI_desc.odt (заготовка под том Plugin API) |
...
Очищенные выдержки из ODT: папка [`sources/`](sources/).
...
1. Новый разработчик — прочитать разделы 1–3 в `01-Script-API-Reference.md`, затем cookbook.
