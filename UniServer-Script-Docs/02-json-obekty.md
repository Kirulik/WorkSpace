...
Возвращает строку, заключённую в JSON-кавычки. Нужна при ручной сборке JSON-текста.
...
Возвращает строку с экранированными спецсимволами JSON. Готовит фрагмент текста к безопасной вставке в JSON.
...
Возвращает новый пустой JSON-массив. Дальше в него добавляют элементы через `Add` или обращаются по индексу.
...
Возвращает JSON-массив, сразу заполненный переданными значениями. Удобно собрать список аргументов или значений фильтра одним вызовом.
...
Возвращает новый пустой JSON-объект. Дальше в него добавляют поля через `AddValue` или присваивание по имени.
...
Возвращает JSON-объект из переданных пар имя—значение. Типичный способ быстро собрать документ, фильтр или аргументы процедуры.
...
Возвращает JSON-объект или JSON-массив, разобранный из строки. Основной вход для разбора текстового JSON в структуру скрипта.
...
Возвращает копию значения. Для JSON-объекта/массива копирование идёт через строковое представление, чтобы получить независимую копию структуры.
...
Возвращает тип JSON-переменной (`dvObject`, `dvArray` или `dvUndefined`). Позволяет отличить объект от массива перед обходом.
...
Возвращает число элементов в JSON-массиве или полей в JSON-объекте.
...
Возвращает имя поля JSON-объекта по индексу. Используется при обходе объекта вместе с `Value`.
...
Возвращает (или задаёт) значение элемента JSON-массива либо поля JSON-объекта по индексу.
...
Возвращает `True`, если в объекте есть поле с указанным именем (или в массиве — указанное значение).
...
Возвращает индекс добавленного элемента. Добавляет значение в конец JSON-массива.
...
Возвращает индекс добавленного поля. Добавляет в JSON-объект пару имя—значение.
...
Удаляет элемент JSON-массива или поле JSON-объекта по индексу.
...
Возвращает текстовое представление JSON-объекта или JSON-массива.
