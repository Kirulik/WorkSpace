...
Возвращает результат SQL-запроса к таблице журнала.
...
Возвращает результат SQL-запроса к внешней БД журнала.
...
Возвращает документ записи журнала по `Code`.
...
Возвращает набор записей журнала по параметрам поиска.
...
Возвращает код сохранённой записи журнала.
...
Возвращает код записи, сохранённой без запуска триггеров.
...
Возвращает данные именованного представления журнала.
...
Возвращает результат хранимой процедуры журнала.
...
Возвращает набор вложений записи журнала.
...
Возвращает содержимое именованного вложения записи.
...
Сохраняет именованное вложение записи журнала.
...
Возвращает результат создания связи между записями журналов.
...
Возвращает результат создания связи без запуска триггеров.
...
Возвращает данные связи записи по имени.
...
Возвращает `CODE` связанной записи по имени связи.
...
Возвращает список связей записи.
...
Восстанавливает ранее удалённые связи записи.
...
Удаляет связи записи без запуска триггеров.
...
Восстанавливает ранее удалённые связи без запуска триггеров.
...
Ставит сохранение записи журнала в очередь асинхронно.
...
Ставит сохранение записи без триггеров в очередь асинхронно.
...
Ставит вызов хранимой процедуры журнала в очередь асинхронно.
...
Ставит создание связи записей в очередь асинхронно.
...
Ставит создание связи без триггеров в очередь асинхронно.
