...
Возвращает hex-строку из 2 символов для значения `Byte`.
...
Возвращает hex-строку из 4 символов для значения `Word`.
...
Возвращает hex-строку из 8 символов для значения `Integer`.
...
Возвращает hex-строку из 16 символов для значения `Int64`.
...
Возвращает целое (Word), разобранное из hex-строки.
...
Возвращает hex-строку для текста с учётом указанной кодовой страницы. Мост между строкой скрипта и байтовым представлением протокола.
...
Возвращает текст, восстановленный из hex-строки с учётом кодовой страницы.
