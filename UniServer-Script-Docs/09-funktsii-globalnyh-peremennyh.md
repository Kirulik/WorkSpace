...
Возвращает время последнего изменения глобальной переменной Конструктора.
...
Возвращает счётчик изменений глобальной переменной Конструктора.
...
Возвращает частоту изменений глобальной переменной Конструктора.
