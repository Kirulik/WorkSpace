...
Возвращает время последнего изменения глобальной переменной Конструктора. При отсутствии переменной с таким именем вызывается исключение; удобно для таймаутов по «давности» состояния.
...
Возвращает счётчик изменений глобальной переменной Конструктора. При отсутствии переменной вызывается исключение.
...
Возвращает частоту изменений глобальной переменной Конструктора. При отсутствии переменной вызывается исключение; используют для мониторинга «живости» канала данных.
