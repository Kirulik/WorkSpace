...
Возвращает новый объект сообщения с именем и полезной нагрузкой `Value`.
...
Возвращает новый объект сообщения с Blob, пользователем и таймаутом.
...
Ставит сообщение в очередь асинхронно без ожидания ответа.
...
Возвращает поле `Result` сообщения после синхронной обработки подписчиками.
