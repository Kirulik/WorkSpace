...
Возвращает значение `V` как `Double`.
...
Возвращает новую строку packed GUID.
...
Возвращает `True`, если строка имеет формат packed GUID.
...
Приостанавливает выполнение скрипта на заданное число миллисекунд.
...
Возвращает `True`, если Variant пуст или равен `Null`.
...
Выводит значение в лог плагина для отладки сценария.
