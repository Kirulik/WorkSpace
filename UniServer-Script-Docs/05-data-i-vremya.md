...
Возвращает `TDateTime`, разобранный из строки ISO 8601. Обменный формат меток времени между плагинами, журналами и веб-страницами.
...
Возвращает строку ISO 8601 для переданного `TDateTime`. Так сохраняют и передают даты в документах и сообщениях.
...
Возвращает число миллисекунд между двумя метками времени. Типично для таймаутов и проверки «давности» события.
...
Возвращает текущее локальное время сервера с высокой точностью.
...
Возвращает текстовое представление периода, заданного в тиках.
